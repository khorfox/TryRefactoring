...
import com.telecomitalia.dynamic.omc.ManagerEmpty;
import com.telecomitalia.dynamic.omc.ManagerEriGsm;
import com.telecomitalia.dynamic.omc.ManagerEriLte;
import com.telecomitalia.dynamic.omc.ManagerEriUmts;
import com.telecomitalia.dynamic.omc.ManagerHuaGsm;
import com.telecomitalia.dynamic.omc.ManagerHuaLte;
import com.telecomitalia.dynamic.omc.ManagerHuaUmts;
import com.telecomitalia.dynamic.omc.ManagerNsnGsm;
import com.telecomitalia.dynamic.omc.ManagerNsnLte;
import com.telecomitalia.dynamic.omc.ManagerNsnUmts;
import com.telecomitalia.dynamic.omc.env.EnvironmentManager;
import com.telecomitalia.dynamic.omc.model.Costruttore;
import com.telecomitalia.dynamic.omc.model.Tecnologia;

public class Client extends ClientGeneric {
	...
	public static void main(String[] args) throws Exception {
		if (args.length == 0) {
			...
			String parametri = client.getParametriJdk();
	...
	private String getParametriJdk() {
		EnvironmentManager env = new EnvironmentManager();
		return env.getParametri();
	}
